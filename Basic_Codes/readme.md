-> This section discusses about basic OpenACC clauses, constructs like parallel construct, kernels construct, async clause, num_gangs clause, shallow copying concept.    
